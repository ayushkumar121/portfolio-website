...
var _pageTransition = new _highway.default.Core({
  transitions: {
    default: _transition.default
  }
});
/*
const tl = new TimelineLite({ repeat: -1, delay: 1})
tl
    .from(".floating-cards", 2, {
        y: 20
    })
    .to(".floating-cards", 2, {
        y: 20
...
document.querySelectorAll('.animated-text').forEach(function (at) {
  _gsap.gsap.from(at, 1, {
    scrollTrigger: at,
    y: 50,
    opacity: 0
  });
...
menuTrigger.addEventListener('click', function () {
  if (!menuToggled) {
    _gsap.gsap.to('.overlay', .5, {
      top: '0%',
      ease: 'power2.out'
    });

    _gsap.gsap.to('#menu-button svg', .5, {
      fill: '#fff'
    });
  } else {
    _gsap.gsap.to('.overlay', .5, {
...
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.module.js","gsap":"node_modules/gsap/index.js","gsap/ScrollTrigger":"node_modules/gsap/ScrollTrigger.js","./transition":"js/transition.js"}],"../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
